...
- **Examples**
    ...
    - [Historical Data & Forecasting](examples/history.md): Fast-forward simulation time to generate datasets or predict future states.
- **Advanced Guides**
    ...
    - [Data Lake Ingestion & Storage](guides/data-lake-ingestion.md): Configure PyArrow VFS for AWS S3, UUID chunking, and schema drift prevention.
